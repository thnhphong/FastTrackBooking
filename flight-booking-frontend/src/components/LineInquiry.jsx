...
const LineInquiry = ({ isMobile }) => {
  return (
    <div className="fixed bottom-5 right-7 p-1 bg-white rounded-md z-50 max-[1025px]:hidden">
      <div className="flex flex-col items-center gap-2 p-2 fill-[#00AE00]">
        <a href="https://page.line.me/vietjapan.vip" className={`w-11 h-11 hover:scale-90 transition-all duration-300 ${isMobile ? 'w-8 h-8' : ''}`}>
