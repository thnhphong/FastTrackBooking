  ...
  return (
    <nav className="bg-white w-[100vw] flex justify-evenly align-center mx-auto">
      <div className="w-[100vw] flex justify-evenly align-center px-4 py-3">
        <div className="flex max-[768px]:flex-col items-center gap-6 md:flex-row md:justify-between md:items-center md:gap-10 md:h-20">
          {/* 1. Logo */}
          <a href="https://vietjapan.vip" className="flex-shrink-0 max-[1025px]:scale-1.4">
            <img
              ...
              className="h-auto object-contain max-w-[15vw] max-[1025px]:max-w-[28vw] max-[768px]:max-w-[85vw]"
            />
          </a>

          <div className="flex flex-row justify-between items-center gap-15 max-[769px]:gap-15 max-[450px]:gap-5 max-[390px]:gap-0">
            {/* Desktop Menu */}
            <div className="flex flex-row justify-center md:space-x-8 items-center">
              {/* 2. すぐ予約 Button */}
              <a
                href="https://vietjapan.vip/book-now/"
                className="bg-[#00ae00] hover:bg-[#2dae00] text-white font-regular text-lg px-10 py-5 max-[1025px]:px-8 max-[1025px]:py-3  rounded-[10px] transition-colors duration-300 max-[1025px]:scale-75 max-[768px]:whitespace-nowrap"
              >
                すぐ予約
              </a>

              {/* 3. Main Navigation */}
              <ul className="flex md:flex-wrap md:items-center md:space-x-10 block max-[1025px]:hidden">
                <li>
                  <a
            ...
            <div className="flex flex-col items-center gap-2 p-2 fill-[#00AE00] hidden max-[1025px]:flex">
              <a href="https://page.line.me/vietjapan.vip" className="w-11 h-11 hover:scale-90 hover:opacity-80 transition-all duration-300">
              ...
              <a href="https://page.line.me/vietjapan.vip" className="text-base text-black max-[768px]:whitespace-nowrap">
                <strong>LINEお問い合わせ</strong>
              </a>
            </div>

            {/* Mobile Menu Button - hamburger & x icons */}
                ...
                <div className="absolute max-[1025px]:block max-[768px]:top-70 top-24 left-0 w-full bg-white z-50 flex justify-center items-center transition-all duration-300">
                  <div className="text-center w-full">
                    ...
                    <button
                      ...
                      className="w-full text-gray-800 hover:text-[#0d1f49] text-sm font-light border-b border-[#01ae00] hover:bg-[#01ae00] hover:text-white py-2 flex justify-center items-center text-black"
                    >
