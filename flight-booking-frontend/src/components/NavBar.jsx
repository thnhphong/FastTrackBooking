          ...
          <div className="flex flex-row justify-between items-center gap-20 max-[768px]:gap-10">
            ...
            <div className="flex flex-row justify-center md:space-x-8 items-center">
              ...
              <a
                ...
                className="bg-[#00ae00] hover:bg-[#2dae00] text-white font-bold text-lg px-10 py-5 rounded-[10px] transition-colors duration-300 max-[1025px]:scale-75 max-[768px]:whitespace-nowrap"
              >
                すぐ予約
              </a>
