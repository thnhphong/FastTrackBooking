      ...
      <div className="w-full custom:max-w-[1140px] px-4 py-8 pb-32 text-left border border-gray-200 rounded-lg">
        ...
        <div className="mb-6 p-4 text-left flex-col justify-center">
          <div className="flex flex-col text-[15px] text-gray-700 text-center mb-6">
            <p>
              ✔️No account registration required ✔️No passport photo submission required\ ✔️Polite and careful service ✔️Same-day booking available
            </p>
            <p>✔️24-hour Japanese support ✔️No extra fee for night/early morning ✔️Easy booking ✔️Japanese receipt available</p>
            <p className="text-red-600 underline text-center">
              <a href="https://vietnam-fasttrack.com/vjp-fasttrack-december-esim-campaign/?_gl=1*atd23l*_gcl_au*MTk5MDI3MTkzOS4xNzY0MDQ3NDEyLjE4OTg5OTIyNjAuMTc2NTgwMzE3Mi4xNzY1ODAzMTcy" target='_blank'>🎁 High-speed data eSIM (30GB/5 days, worth $10) free gift now! Details here</a>
            </p>
          </div>

          {/* line esim */}
          <div className="flex flex-col text-[15px] font-bold text-right text-blue-700 underline">
            <a href="https://vietjapan.vip/line-chat/" target='_blank'>📱 Reserve via LINE for eSIM gift ＞＞</a>
          </div>

        </div>
        {/* Your desired service */}
        <div className="mb-6">
          <h2 className="text-xl font-bold text-black mb-4 text-left">Your Desired Service</h2>
          ...
          <div className="mb-4">
            <label className="flex items-center cursor-pointer">
              ...
              />
              <span className="text-black text-base"> Arrival Fast Track Service (from $35)</span>
            </label>
          </div>
            ...
            <div className="mb-6 w-full">
              ...
              <div className="grid grid-cols-2 max-[640px]:grid-cols-1 gap-4">
                ...
                {formData.entry_fast_track_option !== 3 && (
                  <div className="mt-6">
                    <FieldRequired
                      label="Complete immigration process within 15 minutes"
                      required={true}
                      ...
                      <fieldset className="space-y-2 border-none p-0 m-0">
                        ...
                        <label className="flex items-center cursor-pointer">
                          <input
                            ...
                            className={`w-4 h-4 focus:outline-none cursor-pointer ${errors.use_immigration_fast_track && (!formData.use_immigration_fast_track || formData.use_immigration_fast_track === '') ? 'border-[#c02b0b] text-[#c02b0b]' : 'text-blue-600 border-gray-300'}`}
                          />
                          <span className={`ml-3 text-base ${errors.use_immigration_fast_track && formData.use_immigration_fast_track === undefined ? 'text-[#c02b0b]' : 'text-black'}`}>Use (15$)</span>
                        </label>
                        <p className="text-md text-[#1362cb] mt-2 text-left">
                          ※By using the "Diplomatic Lane", the immigration process will be completed the shortest time. If it takes more than 15 minutes, $15 will be refunded. It is recommended for those without baggage.
                        </p>
                      </fieldset>
                    </FieldRequired>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  <FieldRequired label="Eligible airports" required={true} error={errors.arrival_airport} isEmpty={formData.arrival_airport === '' || formData.arrival_airport === null || formData.arrival_airport === undefined}>
                    <fieldset className="space-y-2 border-none p-0 m-0">
              ...
              <div className="mt-6 ">
                <label className="flex items-center cursor-pointer text-left ">
                  ...
                  />
                  <span className="ml-3 text-base text-black">Other Options</span>
                </label>
              </div>
              ...
              {formData.useOtherOptions && (
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 max-[640px]:grid-cols-1 gap-6 max-[640px]:gap-4 p-4 max-[640px]:px-8">
                  ...
                  <div>
                    <FieldRequired
                      label="Choose to be picked up at the plane exit (or bus stop):"
                      required={true}
                    ...
                    >
                      ...
                      <fieldset className="space-y-2 border-none p-0 m-0 max-[640px]:grid grid-cols-2 gap-4">
                        <label className="flex items-center cursor-pointer">
                          ...
                          />
                          <span className={`ml-3 text-base ${errors.tarmac_pickup && formData.tarmac_pickup === false ? 'text-[#c02b0b]' : 'text-black'}`}>Do not use</span>
                        </label>
                        <label className="flex items-center cursor-pointer">
                          <input
                            type="radio"
                            ...
                            className={`w-4 h-4 focus:outline-none cursor-pointer ${errors.tarmac_pickup && formData.tarmac_pickup === 'false' ? 'border-[#c02b0b] text-[#c02b0b]' : 'text-blue-600 border-gray-300'}`}
                          />
                          <span className={`ml-3 text-base ${errors.tarmac_pickup && formData.tarmac_pickup === false ? 'text-[#c02b0b]' : 'text-black'}`}>Use (60$)</span>
                        </label>
                      </fieldset>
                    </FieldRequired>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                ...
                <div>
                  <label className="block text-base font-medium text-black mb-2 text-left">
                    Please fill in any other requests you may have.
                  </label>
                  <textarea
          ...
          <div className="mb-4">
            <label className="flex items-center cursor-pointer">
              <input
                ...
                className="w-5 h-5 mr-3 text-blue-600 border-gray-300 rounded focus:outline-none"
              />
              <span className="text-black text-base">Use of the Departure Fast Track (from $50)</span>
            </label>
          </div>
          ...
          {formData.useEmigration && (
            <div className="mb-6 w-full">
              <div className="mb-6">
                <FieldRequired label="Departure Fasttrack" required={true} error={errors.departure_fast_track_option} isEmpty={formData.departure_fast_track_option === '' || formData.departure_fast_track_option === null || formData.departure_fast_track_option === undefined}>
                  <fieldset className="space-y-2 border-none p-0 m-0">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  <FieldRequired
                    label="Flight Reservation Number or Reservation Code"
                    required={true}
                  ...
                  >
                    <input
                      ...
                      onChange={handleInputChange}
                      required={formData.useEmigration}
                      placeholder="Reservation Number or Reservation Code"
                ...
                <div>
                  <FieldRequired label="Eligible airports" required={true} error={errors.departure_airport_code} isEmpty={formData.departure_airport_code === '' || formData.departure_airport_code === null || formData.departure_airport_code === undefined}>
